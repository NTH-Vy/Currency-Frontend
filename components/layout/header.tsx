        ...
        if (data.success) {
          ...
          const notifications = data.notifications.map((notif: ApiNotification) => ({
            ...
            title: notif.type === 'like'
              ...
              ? `@${notif.actor_username} replied to your comment`

              : notif.type === 'mention'

              ? `@${notif.actor_username} mentioned you`
            ...
            content: notif.comment_content || notif.actor_username || '',
                            ...
                            >
                              ...
                              <div className="flex flex-col min-w-0">
                                ...
                                <span className="text-[11px] text-slate-400 truncate">
                                  ...
                                  {user.facebook_id ? 'Facebook Account' : user.google_id ? 'Google Account' : 'Email Account'}
